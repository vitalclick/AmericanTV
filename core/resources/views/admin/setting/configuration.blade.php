                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('FFmpeg ')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the video will upload multiple resoulution.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="ffmpeg_status"
                                        @if (gs('ffmpeg_status')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Storage System')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the video will upload your storage.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="is_storage"
                                        @if (gs('is_storage')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Playlist Sell')</p>
                                    <p class="mb-0">
                                        <small>@lang('Enable this to allow selling playlists individually.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        name="is_playlist_sell" @if (gs('is_playlist_sell')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Monthly Subscription')</p>
                                    <p class="mb-0">
                                        <small>@lang('Enable this to offer users a monthly subscription plan.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="is_monthly_subscription"
                                        @if (gs('is_monthly_subscription')) checked @endif>
                                </div>
                            </li>
